...
# The composed access policy is the supplied unrestricted one. It is named here
# explicitly rather than defaulted inside the adapter so that the checkpoint at
# which enforcement changes is a visible one-line composition change.
access_constraints = UnrestrictedAccessConstraints()
